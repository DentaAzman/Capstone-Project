...
<footer class="text-center text-lg-start text-black">
        ...
        <section class="footer__content">
          <div class="row">
            <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
              <h5 class="text-uppercase">ECO.TOUR</h5>
            ...
            <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
              ...
              <ul class="list-unstyled mb-0">
                <li>
                  <a href="#/explore-canggu" class="text-black">Canggu</a>
                </li>
                <li>
                  <a href="#/explore-seminyak" class="text-black">Seminyak</a>
                </li>
                <li>
                  <a href="#/explore-kintamani" class="text-black">Kintamani</a>
                </li>
                <li>
                  <a href="#/explore-ubud" class="text-black">Ubud</a>
                </li>
              </ul>
            </div>
            ...
            <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
              ...
              <ul class="list-unstyled mb-0">
                <li>
                  <a href="#/explore-kuta" class="text-black">Kuta</a>
                </li>
                <li>
                  <a href="#/explore-nusadua" class="text-black">Nusa Dua</a>
                </li>
                <li>
                  <a href="#/explore" class="text-black">Explore</a>
                </li>
                <li>
      ...
      <div
        ...
        style="background-color: rgba(5, 107, 3, 0.2)"
      >
